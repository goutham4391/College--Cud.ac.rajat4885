    ...
    */
        ...
        attach: function (context, settings) {
           ...
           if (settings) {
                ...
                if ( settings.path ) {
                    ...
                    if ( settings.path['currentPath'].indexOf("academic/student-works") != -1 ) {
                        $('a.nav-link').on('click', function (e) {
                            ...
                            var filter = $('#views-exposed-form-student-works-main select[name="field_student_works_target_id"]');
                            filter.val(id);
                            ...
                            $('#views-exposed-form-student-works-main select[name="field_student_works_target_id"]').trigger('change');
                            $('#views-exposed-form-student-works-main input.form-submit').trigger('click');
    ...
    $(document).ajaxComplete(function (event, xhr, settings) {
        ...
        if ( settings.data ) {
            ...
            if ( settings.data.indexOf("view_name=student_works") != -1 ) {

                if (settings.data.indexOf("view_display_id=main") != -1) {

                    // Do it! Trigger the select box
                    var filter_id = $('#views-exposed-form-student-works-main select[name="field_student_works_target_id"]').find(":selected").val();

                    $('a.nav-link').removeClass('active');
                    $('a#' + filter_id + '.nav-link').addClass('active');
